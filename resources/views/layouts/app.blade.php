        ...
        <nav class="sticky-top navbar navbar-default navbar-static-top">
            <div class="container">
                    <div class="navbar-header col-md-3 col-sm-2">
                        <!-- Branding Image -->
                        <a class="" href="{{ url('/') }}">
                            <img src="img/WaziLogo.png" alt="Wazi Logo" class="img-responsive" style="width:3vw;">
                        </a>
                    </div>
                    <div class="collapse navbar-collapse col-md-9 col-sm-4" id="app-navbar-collapse">
                        <!-- Left Side Of Navbar -->
